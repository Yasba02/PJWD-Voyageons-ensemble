...
router.get('/publish.html', (req, res) => {
    res.sendFile(path.join(__dirname, '../publish.html')); 
});

// Route for Destinations page
router.get('/destinations.html', (req, res) => {
    res.sendFile(path.join(__dirname, '../destinations.html')); 
});

// Routes for other static HTML pages...
router.get('/africa.html', (req, res) => {
    res.sendFile(path.join(__dirname, '../africa.html')); 
});
router.get('/america.html', (req, res) => {
    res.sendFile(path.join(__dirname, '../america.html')); 
});
router.get('/asia.html', (req, res) => {
    res.sendFile(path.join(__dirname, '../asia.html')); 
});
router.get('/europe.html', (req, res) => {
    res.sendFile(path.join(__dirname, '../europe.html')); 
});
router.get('/oceania.html', (req, res) => {
    res.sendFile(path.join(__dirname, '../oceania.html')); 
});
